...
//   Search kısmında toogle efektini vermek için kullanıyoruz. 
searchBtn.addEventListener("click", () => {
    search.classList.toggle("active") //add verilseydi çıkarma işlemi olmazdı
})
...
const createPokemonCard = (pokemon) => {
    ...
    <!-- yukarıdaki kısımda js ile sayı.png şekilde dinamiklik getireceğiz -->
</div>
<div class="poke-info">
    <span class="poke-id">
        #${pokemonId}
